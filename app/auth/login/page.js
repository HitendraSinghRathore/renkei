  ...
  return (
    <div className="h-screen overflow-hidden">
      ...
      <section className="bg-gray-100 w-full h-full py-20 px-2 sm:px-4 md:px-8">
        <div className="mx-auto bg-white rounded-lg shadow pt-8 p-6  md:p-10 border border-gray-200 w-full sm:w-2/3 max-w-md">
          ...
          <button className="bg-white border border-primary  rounded-sm md:rounded-md py-2 px-4   w-full text-primary text-sm hover:bg-pink-100 hover:shadow-md transition mb-4">Sign in with Google</button>
