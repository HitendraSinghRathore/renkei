...
export default function HeroSection() {
  return (
    <section className="mx-auto mt-4 mb-10 md:mt-8 md:mb-20 w-100 px-4">
      <div className="w-full mx-auto bg-red-100 border border-gray-200 rounded-xl hero-section flex flex-col items-center justify-center py-12 px-4 md:py-16 md:px-6 lg:py-24 lg:px-8 ">
        ...
        <Link
          ...
          role="button"
          href="/"
          className="bg-primary hover:bg-pink-600 text-white rounded-xl transition px-4 py-2 sm:py-4 font-bold text-sm md:text-lg md:text-base"
        >
          Go to dashboard
        </Link>
      </div>
