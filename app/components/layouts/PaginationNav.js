...
export default function PaginationNav({ page, limit, total,totalPages,hasNext,hasPrev, onPageChange }) {
    ...
    <div className="hidden sm:block ">
      <p className="text-sm text-gray-700">
        ...
        <a href="#" className={hasPrev ? "relative inline-flex items-center rounded-l-md px-2 py-2 text-gray-400 ring-1 ring-gray-300 ring-inset hover:bg-gray-50 focus:z-20 focus:outline-offset-0 bg-white": "hidden"}>
      ...
      {rightPages.map((p) => (
        ...
        <a href="#" className={hasNext ? "relative inline-flex items-center rounded-r-md px-2 py-2 text-gray-400 ring-1 ring-gray-300 ring-inset hover:bg-gray-50 focus:z-20 focus:outline-offset-0 bg-white  bg-white": "hidden"}>
